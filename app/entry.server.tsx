...
export default async function handleRequest(
  ...
  setFrameAncestorsCsp(responseHeaders);
...
function setFrameAncestorsCsp(headers: Headers): void {
  ...
  if (!/frame-ancestors/i.test(current)) {
    headers.set("Content-Security-Policy", `${current}; ${frameAncestors}`);
  }
}
